        ...
        <div className="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-md">
          ...
          <div className="flex items-center">
            <input
              ...
              placeholder={searchType === 'buy' ? 'Enter location, property type, or keywords' : 'Enter your property address'}
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {popularSearches.map((search, index) => (
                <button key={index} className="flex items-center rounded-full bg-gray-200 px-3 py-1 text-sm text-gray-700 hover:bg-gray-300">
